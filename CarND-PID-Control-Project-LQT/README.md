...
* The hyperparameters were chosen by manual tuning. It was (0.14, 0.0001, 3.0) and it worked well. I firstly started with (1,1,1), but it looked awful. Then I tried (1,0,0), (0,1,0), and (0,0,1). Comparing these three cases, for (1,0,0) and (0,0,1) cases, the car were trying to move straightly on the road, but for (0,0,1) one, the car went off road at the very beginning. So, for intuition, I think parameter P and D weighted more, and I should be impact the steering very small or not at all. So I started tuning with (1,0,1).

*  Then I tried to tune parameter P and D several times by observing the behaviors of the car, and finally determine the hyperparameter as (0.14,0,3). At that time the car had already run well, but not quite smoothly. So I add a very small I-parameter to have it run smoothly, and finally got (0.14,0.00002,3.0).
