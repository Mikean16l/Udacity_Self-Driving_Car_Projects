...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t = 0; t < N; t++) {
      fg[0] += 880*CppAD::pow(vars[cte_start + t], 2);
      fg[0] += 880*CppAD::pow(vars[epsi_start + t], 2);
    ...
    for (int t = 0; t < N - 1; t++) {
      ...
      fg[0] += 60*CppAD::pow(vars[a_start + t], 2);
    ...
    for (int t = 0; t < N - 2; t++) {
      fg[0] += 240000*CppAD::pow(vars[delta_start + t + 1] - vars[delta_start + t], 2);
